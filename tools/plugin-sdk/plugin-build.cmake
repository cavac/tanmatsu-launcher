...
set(PLUGIN_STUB_LIB "${PLUGIN_STUB_LIB_DIR}/libplugin.so")
...
function(build_tanmatsu_plugin PLUGIN_NAME PLUGIN_SOURCES)
    ...
    # Create directory for stub library
    file(MAKE_DIRECTORY ${PLUGIN_STUB_LIB_DIR})

    # Build the stub library first (only once per build)
    if(NOT TARGET plugin_stub_lib)
        add_custom_command(
            OUTPUT ${PLUGIN_STUB_LIB}
            COMMAND ${CMAKE_C_COMPILER}
                ...
                -o ${PLUGIN_STUB_LIB}
                ${PLUGIN_STUB_SOURCE}
            DEPENDS ${PLUGIN_STUB_SOURCE}
            COMMENT "Building plugin stub library"
        )
        add_custom_target(plugin_stub_lib DEPENDS ${PLUGIN_STUB_LIB})
    endif()
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_C_COMPILER}
            ...
            -Wl,--no-as-needed
            -L${PLUGIN_STUB_LIB_DIR}
            -lplugin
            -o ${PLUGIN_OUTPUT}
            $<TARGET_OBJECTS:${PLUGIN_NAME}_obj>
        DEPENDS ${PLUGIN_NAME}_obj plugin_stub_lib
