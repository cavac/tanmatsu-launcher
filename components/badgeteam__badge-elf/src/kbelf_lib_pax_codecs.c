...
extern char const symbol_pax_encode_png_fd[] asm("pax_encode_png_fd");
extern char const symbol_pax_encode_png_buf[] asm("pax_encode_png_buf");
...
kbelf_builtin_lib const badge_elf_lib_pax_codecs = {
